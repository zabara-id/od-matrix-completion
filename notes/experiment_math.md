...
![Относительная ошибка потоков (выбор наблюдаемых рёбер по модулю потоков)](../plots_top_worst_random_obs/relative_flow_error.png)

![Относительная ошибка восстановления матрицы (выбор наблюдаемых рёбер по модулю потоков)](../plots_top_worst_random_obs/rel_matrix_error.png)
