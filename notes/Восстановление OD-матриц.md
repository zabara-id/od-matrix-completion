...
Решение: градиент $A^\top W(Ad-\hat f)$, проксимальный шаг по KL (мультипликативный апдейт (?)), затем IPF-проекция на маргиналии. Похоже, это может быть быстро и просто, подойдет для того, чтобы выработать базу под более сложные постановки.
